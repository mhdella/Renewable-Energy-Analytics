...
# lat=42.2756887
# lon=-71.21161789999996  ## 10mi North East of Boston
# ###Boulder  
# lat=40.0150
# lon=-105.2705    ##Boulder  

###Boulder  
lat=35.2271
lon=-80.8431    ##Charlotte
...
# df<-read_csv('C:/Users/Mhdella/Desktop/wind_time_series_analysis/wind_data_2009_Charlotte.csv',skip=3,col_types = cols())
